    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2 space-y-6">
          {cartItems.map((item) => (
            <div key={`${item.id}-${item.customText}`} className="flex items-center bg-white p-4 rounded-xl shadow-sm border border-love-pink/20">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white p-6 rounded-xl shadow-md border border-love-pink/20 sticky top-24">
