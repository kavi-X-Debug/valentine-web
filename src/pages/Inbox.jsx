                    ...
                    {messages.map((m, index) => {
                      ...
                      return (
                        <motion.button
                          ...
                          className={
                            'w-full flex items-start gap-3 px-3 py-3 text-left border-b border-love-pink/10 last:border-b-0 ' +
                            (isActive ? 'bg-love-light/80 shadow-sm' : 'hover:bg-love-light/40')
                          }
                        >
                          <div
                            className={
                  ...
                  <AnimatePresence mode="wait" initial={false}>
                    {!selected && (
                      <motion.div
                        ...
                        className="flex-1 flex flex-col items-center justify-center text-center px-4 py-6 text-sm text-gray-500"
                      >
